...
class TrumaiNetBoxAppAldeStatus : public TrumaStausFrameResponseStorage<StatusFameAldeStatus, StatusFameAldeStatusResponse> {
 public:
  StatusFameAldeStatusResponse *update_prepare() override;
